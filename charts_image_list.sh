...
echo cleaning the difficult helm charts... they are
echo artifactory
...
#docker.bintray.io/jfrog/artifactory-pro                                       ####### artifactory-ha ########
#docker.bintray.io/jfrog/nginx-artifactory-pro
